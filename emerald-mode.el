  ...
  (concat "\\(?:^\\s-*\\|:\\s-+\\)"
          (regexp-opt
           '("a" "abbr" "acronym" "address" "applet" "area" "article" "aside"
             ...
             "keygen" "kbd" "label" "legend" "li" "link" "map" "main" "mark"
             "menu" "meta" "metas" "meter" "nav" "noframes" "noscript" "object"
             "ol" "optgroup" "option" "output" "p" "param" "pre" "progress" "q"
             "rp" "rt" "ruby" "s" "samp" "script" "scripts" "section" "select"
             "small" "source" "span" "strike" "strong" "style" "styles" "sub"
             "sup" "table" "tbody" "td" "textarea" "tfoot" "th" "thead" "time"
             "title" "tr" "tt" "u" "ul" "var" "video" "xmp") 'words))
  "Regex for html tags.")
